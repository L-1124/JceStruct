...
def test_struct_decode() -> None:
    ...
    b = SsoServerInfo(server="rcnb", port=8000, location="rcnb", extra="xxx")
    assert a == b
...
def test_struct_nested_decode() -> None:
    ...
    assert ServerListResponse.decode(encoded, extra="xxx") == raw
...
def test_struct_list_decode() -> None:
    ...
    assert len(SsoServerInfo.decode_list(encoded, 2, extra="xxx")) == 11
